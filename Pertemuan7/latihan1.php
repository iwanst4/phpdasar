...
<body>
    ...
    <ul>
        <?php foreach( $pegawai as $peg) : ?>
            <li><a href="latihan2.php?nama=<?= $peg["nama"]; ?>&niy=<?= $peg["niy"]; ?>&email=<?= $peg["email"]; ?>&jabatan=<?= $peg["jabatan"]; ?>&gambar=<?= $peg["gambar"]; ?>&h1=<?= $peg["sift"]["h1"]; ?>&h2=<?= $peg["sift"]["h2"]; ?>&h3=<?= $peg["sift"]["h3"]; ?>"><?= $peg["nama"]; ?></a></li>
        <?php endforeach; ?>
    </ul>
</body>
</html>